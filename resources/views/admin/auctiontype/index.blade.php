<x-admin-layout>
    <main class="main-content position-relative border-radius-lg ">
        @include('admin.include.navbar', ['module' => 'Auctiontype', 'link' => 'admin.auctiontypes.index', 'page' => 'list'])
    ...
    $(document).ready(function() {
        if ($.fn.dataTable.isDataTable('#auctiontype-table')) {
            var data = $('#auctiontype-table').DataTable();
        } else {
            var data = $('#auctiontype-table').DataTable({
                paging: false
            });
