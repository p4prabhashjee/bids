<div class="d-flex">
    <a class="btn btn-link text-dark px-3 mb-0" href="{{route('admin.categories.edit', $id)}}"><i
            class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i></a>
    <!-- <a class="btn btn-link text-dark px-3 mb-0" href="{{route('admin.categories.show', $id)}}"><i
